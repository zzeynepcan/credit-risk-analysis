...
def train_and_evaluate(df):
    ...
    # I chose Random Forest here because it handles non-linear relationships well 
    # and is less prone to overfitting than a single decision tree.
    model = RandomForestClassifier(n_estimators=100, random_state=42)
    print("\nTraining Random Forest model (this might take a second)...")
    ...
    print("Model successfully cached to scripts/credit_risk_model.pkl")
